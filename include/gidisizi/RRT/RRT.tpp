...
template<typename NodeType, typename Environment>
void RRT<NodeType, Environment>::advance()
{

}

template<typename NodeType, typename Environment>
bool RRT<NodeType, Environment>::Plan()
{
  bool success = true;
  int nodeId = 2;
  int iter = 0;
...
template<typename NodeType, typename Environment>
void RRT<NodeType, Environment>::connectNewNode(NodeType* qNew, NodeType* qNearest)
{
